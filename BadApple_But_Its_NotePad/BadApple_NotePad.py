...
videoFileName = "C:/Users/dbstn/Desktop/BadApple/badapple.mp4"
...
if(isBadApple) :
    ...
    os.system("mode con cols=" + str(int(consoleVideo._width * consoleVideoScale)) + " lines=" + str(int(consoleVideo._height * consoleVideoScale)) + 1)
...
while true :
    a = 0
    mouse.scroll(0, int((asciiVideoHeight + 6)/3) * asciiFrameLength)
    while a < asciiFrameLength:
        start = time.time()
